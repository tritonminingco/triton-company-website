      ...
      <div className="relative z-10 container-max text-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-inter font-bold mb-6 leading-tight"
          >
          ...
          >
            {[
              ...
              >
                <div className="text-2xl sm:text-3xl lg:text-4xl font-inter font-bold gradient-text mb-2">
                  {stat.number}
                </div>
